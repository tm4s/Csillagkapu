...
public class Box extends Field {
	/**
	 * hozza tartozo ezredes es merleg akit ertesitenie kell ha felveszik rola
	 */
	...
	/**
	 * ha a box amivel utkozott az ezredes tulajdona akkor meghivja az ezredes
	 * doboz felvevo fuggvenyet (csak az ezredes tulajdona lehet maskent nem
	 * utkozhetne vele)
	 * 
	 * @param box
	 *            ezzel utkozott
